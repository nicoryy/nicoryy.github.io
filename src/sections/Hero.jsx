...
import NeuralHeroAnimation from "../components/hero/NeuralHeroAnimation";
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-10 w-full pt-16 grid lg:grid-cols-2 lg:place-items-center">
        {/* Col 1 */}
        <div>
          {/* Comment label */}
          ...
          {/* Name + neural animation (desktop-only enhancement) */}
          <h1 className="text-7xl lg:text-9xl font-extrabold text-text-primary tracking-tight leading-none">
            {personal.handle}
